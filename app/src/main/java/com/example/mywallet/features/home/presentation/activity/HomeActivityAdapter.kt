...
import com.example.mywallet.databinding.ItemHomeActivityTransactionBinding
import com.example.mywallet.features.home.data.HomeTransaction

class HomeActivityAdapter (
    private val onClick: (transactionID: Long) -> Unit,
) : ListAdapter<HomeTransaction, HomeActivityAdapter.TransactionViewHolder>(HomeTransactionDiffCallback()) {

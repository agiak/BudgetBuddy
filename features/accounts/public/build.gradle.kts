...
android {
    namespace = "${ProjectVariables.BASE_FEATURE_NAMESPACE}.accounts"
...
dependencies {
    ...
    // Implement necessary features modules
    implementation(project(":features:account:public")) // Account details and edit screen
    implementation(project(":features:accountAdd:public")) // Add account screen
